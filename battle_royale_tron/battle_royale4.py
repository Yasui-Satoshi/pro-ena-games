...
win_w, win_h = 700, 820                                  # ウインドウサイズ
offset       = win_h - win_w                             # エリア外余白 #60
w, h         = win_w , win_h-offset                      # バトルエリア
#screen       = pg.display.set_mode((win_w, win_h), FULLSCREEN) # ウインドウ生成(フルスクリーン)
...
while  done:
    ...
    for i in wall: pg.draw.rect(screen, WHITE, i, 0)  # 壁書き込み
    ...
    score_text_pos.centery = int(win_h - offset*3 / 4)
    ...
    if   p_score[0] == SET:
        print('player 1 WIN!!')
        screen.blit(win1, (180, 760))
    elif p_score[1] == SET:
        print('player 2 WIN!!')
        screen.blit(win2, (180, 760))
    elif p_score[2] == SET:
        print('player 3 WIN!!')
        screen.blit(win3, (180, 760))
    elif p_score[3] == SET:
        print('player 4 WIN!!')
        screen.blit(win4, (180, 760))
